...
class ArtLoadFavorite extends FavoriteModel {
    ...
    public function allMyFavorite(){
        $this->data = $this->all_favorites($this->field->artId, $this->field->userId, $this->userId);
    ...
    public function removeAllByUser(){
        if($this->userId > 0){
            return $this->delete_all_by_reference($this->field->userId, $this->userId);
        }
        return 0;
    }
