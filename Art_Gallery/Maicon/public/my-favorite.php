...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            <div class="content">
                <p>Create, update and delete profiles.</p>
                <form class="bootstrap-form-with-validation">
                    <h2 class="text-center">Profile form for member.</h2>
                    ...
                    <div class="form-group"><label for="text-input">Username</label><input class="form-control" type="text" name="username"></div>
                    <div class="form-group"><label for="password-input">Password&nbsp;</label><input class="form-control" type="password" name="password-input"></div>
                    <div class="form-group"><label for="text-input">Password Confirm</label><input class="form-control" type="password" name="password-confirm"></div>
                    <div class="form-group"><label for="email-input">Email&nbsp;</label><input class="form-control" type="email" name="email"></div>
