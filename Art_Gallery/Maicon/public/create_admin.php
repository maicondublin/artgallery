...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            <div class="content">
                    <h1 style='text-align:center;margin:50px 0 0;color:#343A40;'>Create Admin or User</h1>
                    <p style='text-align:center;margin:0 0 50px; color:#999;'>Regist an new user or admin</p>
                    <hr>
                <form action="../App/Controller/User/CreateAdmin.Controller.php" method="post" class="bootstrap-form-with-validation">
