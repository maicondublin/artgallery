...
var previous =  "previous-page", next = "next-page", pagination = "page", active = "page-item.active", like = "like-Art", favorite = "favorite-Art";
loadContent();
...
function onclickDetected(target){
    ...
    } else if(targetClass == favorite){

        let elFavorite = target.id;

        Controller = "../App/Controller/Art/Features/AjaxFavoriteClick.Controller.php?idArt="+elFavorite;
        displayTo = "ajax-content";
        ajaxRequest(displayTo, Controller);
