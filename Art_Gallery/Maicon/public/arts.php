...
<body>
    ...
    <div class="wrapper">
        <div class="sidebar" data-color="purple" data-image="" style="background-image:url(&quot;assets/img/7efb12f619792cfa59c13587969d8206.jpg&quot;);">
            ...
            <div class="main-panel" style="padding: 0 12%;">
               <h1 style='text-align:center;margin:50px 0 0;color:black;'>Gallery</h1>
               <p style='text-align:center;margin:0 0 50px; color:#343A40;'>The biggest collection in the world</p>
                <hr>
                <form action="" method="post">
                    ...
                    <div class="my-3" id="numPagination" style="clear:both;"></div>
