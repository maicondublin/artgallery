    ...
    <div class="wrapper">
        <div class="sidebar" data-color="purple" data-image="" style="background-image:url(&quot;assets/img/7efb12f619792cfa59c13587969d8206.jpg&quot;);">
            ...
            <div class="main-panel">
                    <h1 style='text-align:center;margin:50px 0 0;color:#343A40;'>Edit User and Admin</h1>
                    <p style='text-align:center;margin:0 0 50px; color:#999;'>Edit users or admin</p>
                    <hr>
                <div class="content">
                    <form class="bootstrap-form-with-validation" action="../App/Controller/User/UpdateAdmin.Controller.php" method="post">
