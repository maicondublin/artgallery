...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            <div class="content">
            <h1 style='text-align:center;margin:50px 0 0;color:#343A40;'>Edit Art</h1>
            <p style='text-align:center;margin:0 0 50px; color:#999;'>Update your art</p>
            <hr>
                <form class="bootstrap-form-with-validation"  action="../App/Controller/Art/Update.Controller.php" method="post">
